...
|  &nbsp;|  &nbsp;|  &nbsp;+--&nbsp;[redis](./Docker/redis/data/redis)  
|  &nbsp;|  &nbsp;|  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+--&nbsp;[appendonlydir](./Docker/redis/data/redis/appendonlydir)  
|  &nbsp;|  &nbsp;|  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|--&nbsp;[appendonly.aof.1.base.rdb](./Docker/redis/data/redis/appendonlydir/appendonly.aof.1.base.rdb)  
|  &nbsp;|  &nbsp;|  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|--&nbsp;[appendonly.aof.1.incr.aof](./Docker/redis/data/redis/appendonlydir/appendonly.aof.1.incr.aof)  
|  &nbsp;|  &nbsp;|  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+--&nbsp;[appendonly.aof.manifest](./Docker/redis/data/redis/appendonlydir/appendonly.aof.manifest)  
|  &nbsp;|  &nbsp;|--&nbsp;[docker-compose.yml](./Docker/redis/docker-compose.yml)  
|  &nbsp;|  &nbsp;+--&nbsp;[redis](./Docker/redis/redis)  
|  &nbsp;|  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+--&nbsp;[conf](./Docker/redis/redis/conf)  
